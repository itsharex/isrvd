...
func (app *App) defineApisixRoutes() []Route {
	return []Route{
		...
		{Method: "GET", Path: "/apisix/route/:id", Handler: app.apisixGetRoute, Module: "apisix", Label: "查看 APISIX 路由"},
		{Method: "POST", Path: "/apisix/route", Handler: app.apisixCreateRoute, Module: "apisix", Label: "创建 APISIX 路由"},
		{Method: "PUT", Path: "/apisix/route/:id", Handler: app.apisixUpdateRoute, Module: "apisix", Label: "更新 APISIX 路由"},
		{Method: "PATCH", Path: "/apisix/route/:id/status", Handler: app.apisixPatchRouteStatus, Module: "apisix", Label: "切换 APISIX 路由状态"},
		{Method: "DELETE", Path: "/apisix/route/:id", Handler: app.apisixDeleteRoute, Module: "apisix", Label: "删除 APISIX 路由"},
		// Consumer 管理
		{Method: "GET", Path: "/apisix/consumers", Handler: app.apisixListConsumers, Module: "apisix", Label: "列出 APISIX 消费者"},
		{Method: "POST", Path: "/apisix/consumer", Handler: app.apisixCreateConsumer, Module: "apisix", Label: "创建 APISIX 消费者"},
		{Method: "PUT", Path: "/apisix/consumer/:username", Handler: app.apisixUpdateConsumer, Module: "apisix", Label: "更新 APISIX 消费者"},
		{Method: "DELETE", Path: "/apisix/consumer/:username", Handler: app.apisixDeleteConsumer, Module: "apisix", Label: "删除 APISIX 消费者"},
		// 白名单
		...
		{Method: "GET", Path: "/apisix/plugin-config/:id", Handler: app.apisixGetPluginConfig, Module: "apisix", Label: "查看 APISIX 插件配置"},
		{Method: "POST", Path: "/apisix/plugin-config", Handler: app.apisixCreatePluginConfig, Module: "apisix", Label: "创建 APISIX 插件配置"},
		{Method: "PUT", Path: "/apisix/plugin-config/:id", Handler: app.apisixUpdatePluginConfig, Module: "apisix", Label: "更新 APISIX 插件配置"},
		{Method: "DELETE", Path: "/apisix/plugin-config/:id", Handler: app.apisixDeletePluginConfig, Module: "apisix", Label: "删除 APISIX 插件配置"},
		// Upstream 管理
		{Method: "GET", Path: "/apisix/upstreams", Handler: app.apisixListUpstreams, Module: "apisix", Label: "列出 APISIX 上游"},
		{Method: "GET", Path: "/apisix/upstream/:id", Handler: app.apisixGetUpstream, Module: "apisix", Label: "查看 APISIX 上游"},
		{Method: "POST", Path: "/apisix/upstream", Handler: app.apisixCreateUpstream, Module: "apisix", Label: "创建 APISIX 上游"},
		{Method: "PUT", Path: "/apisix/upstream/:id", Handler: app.apisixUpdateUpstream, Module: "apisix", Label: "更新 APISIX 上游"},
		{Method: "DELETE", Path: "/apisix/upstream/:id", Handler: app.apisixDeleteUpstream, Module: "apisix", Label: "删除 APISIX 上游"},
		// SSL 管理
		{Method: "GET", Path: "/apisix/ssls", Handler: app.apisixListSSLs, Module: "apisix", Label: "列出 APISIX 证书"},
		{Method: "GET", Path: "/apisix/ssl/:id", Handler: app.apisixGetSSL, Module: "apisix", Label: "查看 APISIX 证书"},
		{Method: "POST", Path: "/apisix/ssl", Handler: app.apisixCreateSSL, Module: "apisix", Label: "创建 APISIX 证书"},
		{Method: "PUT", Path: "/apisix/ssl/:id", Handler: app.apisixUpdateSSL, Module: "apisix", Label: "更新 APISIX 证书"},
		{Method: "DELETE", Path: "/apisix/ssl/:id", Handler: app.apisixDeleteSSL, Module: "apisix", Label: "删除 APISIX 证书"},
		// 插件列表
