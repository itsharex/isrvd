...
func (app *App) defineComposeRoutes() []Route {
	return []Route{
		// Docker Compose
		{Method: "GET", Path: "/compose/docker/:name", Handler: app.composeDockerInspect, Module: "compose", Label: "读取 Docker Compose 文件"},
		{Method: "GET", Path: "/compose/swarm/:name", Handler: app.composeSwarmInspect, Module: "compose", Label: "读取 Swarm Compose 文件"},
		...
		{Method: "POST", Path: "/compose/docker/:name/redeploy", Handler: app.composeDockerRedeploy, Module: "compose", Label: "重部署 Docker Compose"},
		{Method: "POST", Path: "/compose/swarm/:name/redeploy", Handler: app.composeSwarmRedeploy, Module: "compose", Label: "重部署 Swarm Compose"},
	}
}
