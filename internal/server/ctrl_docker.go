...
func (app *App) defineDockerRoutes() []Route {
	return []Route{
		...
		{Method: "POST", Path: "/docker/containers", Handler: app.dockerCreateContainer, Module: "docker", Label: "创建容器"},
		{Method: "GET", Path: "/docker/containers/:id/stats", Handler: app.dockerContainerStats, Module: "docker", Label: "查看容器统计"},
		{Method: "POST", Path: "/docker/containers/:id/action", Handler: app.dockerContainerAction, Module: "docker", Label: "操作容器"},
		{Method: "GET", Path: "/docker/containers/:id/logs", Handler: app.dockerContainerLogs, Module: "docker", Label: "查看容器日志"},
		{Method: "GET", Path: "/docker/containers/:id/exec", Handler: app.dockerContainerExec, Module: "docker", Label: "打开容器终端"},
		// 镜像管理
		{Method: "GET", Path: "/docker/images", Handler: app.dockerListImages, Module: "docker", Label: "列出镜像"},
		{Method: "POST", Path: "/docker/images/:id/action", Handler: app.dockerImageAction, Module: "docker", Label: "操作镜像"},
		...
		{Method: "GET", Path: "/docker/images/:id", Handler: app.dockerInspectImage, Module: "docker", Label: "查看镜像"},
		// 网络管理
		{Method: "GET", Path: "/docker/networks", Handler: app.dockerListNetworks, Module: "docker", Label: "列出网络"},
		{Method: "POST", Path: "/docker/networks/:id/action", Handler: app.dockerNetworkAction, Module: "docker", Label: "操作网络"},
		{Method: "POST", Path: "/docker/networks", Handler: app.dockerCreateNetwork, Module: "docker", Label: "创建网络"},
		{Method: "GET", Path: "/docker/networks/:id", Handler: app.dockerNetworkInspect, Module: "docker", Label: "查看网络"},
		// 卷管理
		{Method: "GET", Path: "/docker/volumes", Handler: app.dockerListVolumes, Module: "docker", Label: "列出数据卷"},
		{Method: "POST", Path: "/docker/volumes/:name/action", Handler: app.dockerVolumeAction, Module: "docker", Label: "操作数据卷"},
		{Method: "POST", Path: "/docker/volumes", Handler: app.dockerCreateVolume, Module: "docker", Label: "创建数据卷"},
		{Method: "GET", Path: "/docker/volumes/:name", Handler: app.dockerVolumeInspect, Module: "docker", Label: "查看数据卷"},
		// 镜像仓库
		{Method: "GET", Path: "/docker/registries", Handler: app.dockerListRegistries, Module: "docker", Label: "列出镜像仓库"},
		{Method: "POST", Path: "/docker/registries", Handler: app.dockerCreateRegistry, Module: "docker", Label: "添加镜像仓库"},
		{Method: "PUT", Path: "/docker/registries", Handler: app.dockerUpdateRegistry, Module: "docker", Label: "更新镜像仓库"},
		{Method: "DELETE", Path: "/docker/registries", Handler: app.dockerDeleteRegistry, Module: "docker", Label: "删除镜像仓库"},
