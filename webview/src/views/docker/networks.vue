      ...
      <div class="bg-slate-50 border-b border-slate-200 rounded-t-2xl px-4 md:px-6 py-3">
        ...
        <div class="hidden md:flex items-center justify-between">
          ...
          <div class="flex items-center gap-2">
            ...
            <button v-if="actions.hasPerm('POST /api/docker/networks')" @click="createModalRef?.show()" class="px-3 py-1.5 rounded-lg bg-purple-500 hover:bg-purple-600 text-white text-xs font-medium flex items-center gap-1.5 transition-colors">
        ...
        <div class="flex md:hidden items-center justify-between">
          ...
          <div class="flex items-center gap-1 flex-shrink-0">
            ...
            <button v-if="actions.hasPerm('POST /api/docker/networks')" @click="createModalRef?.show()" class="w-9 h-9 rounded-lg bg-purple-500 hover:bg-purple-600 flex items-center justify-center text-white transition-colors" title="创建">
              ...
              <tr v-for="net in networks" :key="net.id" class="hover:bg-slate-50 transition-colors">
                ...
                <td class="px-4 py-3">
                  <div class="flex justify-end items-center gap-0.5">
                    <button v-if="actions.hasPerm('GET /api/docker/networks/:id')" @click="viewNetworkDetail(net)" class="btn-icon text-slate-600 hover:bg-slate-50" title="详情">
                      <i class="fas fa-circle-info text-xs"></i>
                    </button>
                    <button
                      v-if="canDeleteNetwork(net) && actions.hasPerm('POST /api/docker/networks/:id/action')"
